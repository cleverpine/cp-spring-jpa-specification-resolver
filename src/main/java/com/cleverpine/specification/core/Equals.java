...
public class Equals<T> extends SingleValueSpecification<T> {
     ...
     */
    public Equals(String attributePath, String value, QueryContext<T> queryContext, ValueConverter valueConverter) {
    ...
    public Predicate toPredicate(Root<T> root, CriteriaQuery<?> query, CriteriaBuilder criteriaBuilder) {
        ...
        return criteriaBuilder.equal(criteriaExpression, getValueConverter().convert(propertyType, getValue()));
    }
